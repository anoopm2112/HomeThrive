...
import useStyles from './ChildLogsTable.styles.js'
import T from '~/lib/text'

function ChildrenLogsTable({ familyId }) {
  ...
  ] = useLazyQuery(GET_CHILDREN_LOGS, {
  ...
  useEffect(() => {
    if (!exportLoading && exportData) {
      ...
      const logs = exportData?.childrenLogs?.items
...
export default ChildrenLogsTable
