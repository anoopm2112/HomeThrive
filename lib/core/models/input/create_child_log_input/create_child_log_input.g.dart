...
part of 'create_child_log_input.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Map<String, dynamic> _$CreateChildLogInputToJson(
        CreateChildLogInput instance) =>
    <String, dynamic>{
      'childId': instance.childId,
      'secondaryAuthorId': instance.secondaryAuthorId,
