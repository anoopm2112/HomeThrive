...
Future<T> showAppModalBottomSheet<T>({
  ...
  return Navigator.of(context, rootNavigator: useRootNavigator)
      .push(_CustomModalBottomSheetRoute<T>(
    builder: builder,
...
class _CustomModalBottomSheetRoute<T> extends PopupRoute<T> {
...
class _CustomPerModalBottomSheet<T> extends StatefulWidget {
  const _CustomPerModalBottomSheet({
    Key key,
    this.route,
    this.isPersistent,
    this.backgroundColor,
  ...
  _CustomPerModalBottomSheetState<T> createState() =>
      _CustomPerModalBottomSheetState<T>();
}

// ignore: lines_longer_than_80_chars
class _CustomPerModalBottomSheetState<T>
    extends State<_CustomPerModalBottomSheet<T>> {
  String _getRouteLabel(MaterialLocalizations localizations) {
    if ((Theme.of(context).platform == TargetPlatform.android) ||
        (Theme.of(context).platform == TargetPlatform.fuchsia)) {
      return localizations.dialogLabel;
