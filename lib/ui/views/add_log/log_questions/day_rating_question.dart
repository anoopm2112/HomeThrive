...
class DayRatingQuestion extends ViewModelWidget<LogInputViewModel> {
  final MoodRating selectedMoodRating;
  final void Function(MoodRating rating) onMoodRatingSelected;
  final String initialComments;
  final void Function(String comments) onCommentsChanged;
  final String errorText;

  const DayRatingQuestion({
    Key key,
  ...
  Widget build(
    ...
    return Column(
      children: [
        TextColumn(
          headline: localization.dayRatingQuestion,
