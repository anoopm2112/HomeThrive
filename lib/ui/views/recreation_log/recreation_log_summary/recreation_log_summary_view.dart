...
class RecreationLogQuestionSummary extends StatelessWidget {
  ...
  const RecreationLogQuestionSummary({
    Key key,
  ...
  factory RecreationLogQuestionSummary.textAnswer({
    Key key,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (this.activityList?.trim()?.isNotEmpty ?? false)
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 4),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
...
class _LogQuestionSummaryTextAnswer extends RecreationLogQuestionSummary {
  _LogQuestionSummaryTextAnswer({
    Key key,
    @required String question,
    String answer,
